...
import com.example.dwx300.bean.UserInfo;
import com.example.dwx300.database.UserDBHelper;
import com.example.dwx300.util.DateUtil;
import com.example.dwx300.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户", "18990010邓文轩"};
